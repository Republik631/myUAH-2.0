  ...
  form.addEventListener('submit', e => {
    ...
    fetch(scriptURL, { method: 'POST', body: new FormData(form)})
      .then((response) => {
        ...
        document.getElementById("submissionMessage").innerHTML = "</br>Got it. Thanks!</br></br><ul class='nospace group element btmspace-80'><li class='one_half first centered small_screen_stretch'><article><a href='.'><div class='txtwrap yellow-full-border'>Return to Main Page</div></a></article></li></ul>";
